...
public class AddData {
            ...
            
    {
      ...
      pharmaDirectory.addPharmacy(pharma2);
        ...
        drug1.setExpirationDate("20-05-2026");
        drug1.setManufacturedDate("10-09-2023");
        pharma1.getDrugCatalog().addDrugs(drug1);
        
        Drug drug2 = new Drug();
        //drug2.setDrugID(2);
        drug2.setDrugName("Antacid");
        ...
        drug2.setExpirationDate("20-10-2026");
        drug2.setManufacturedDate("10-10-2023");
        pharma1.getDrugCatalog().addDrugs(drug2);
        
        Drug drug12 = new Drug();
        //drug12.setDrugID(3);
        drug12.setDrugName("Renova XR");
        drug12.setDrugType("paracetemol");
        drug12.setComposition("paracetemol");
        drug12.setDrugAvailibility(80);
        drug12.setDrugPrice(30);
        drug12.setDrugDescription("used for acne");
        drug12.setExpirationDate("20-10-2026");
        drug12.setManufacturedDate("10-10-2023");
    ...
    public void setStoreInitialValues(StoreDirectory storeDirectory){
        ...
        store1.setStoreLocation("Ashulia");
        sd.addStore(store1);
        
        store2.setStoreName("Store 2");
        store2.setStoreLocation("Mirpur-10");
        sd.addStore(store2);
